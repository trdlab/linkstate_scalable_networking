var seqNo = 0;
var port = 6662; // UDP port to listen
var msg_buffer = []; // Just for directly connected client messages
var ack_wait_buffer = []; // ACK waiting buffer for all UDP messages
var address = "Server2"; // Address of Server for internal addressing
var clients = {"Client1": "Server1", "Client2": "Server2", "Client3": "Server3"} // Clients and Servers mapping
var prev_neig = "Server1"; // Neighbour mapping
var next_neig = "Server3";
var own_lsp = {src: "Server2", val: {"Server1":1, "Server3":1}}; // Based on Hoop Count
var lsps = [{S:"Server2", T:"Server3", H:1, C:0}, {S:"Server2", T:"Server1", H:1, C:0}]; // Received LSP list
