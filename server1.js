var seqNo = 0;
var port = 6661; // UDP port to listen
var msg_buffer = []; // Just for directly connected client messages
var ack_wait_buffer = []; // ACK waiting buffer for all UDP messages
var address = "Server1"; // Address of Server for internal addressing
var clients = {"Client1": "Server1", "Client2": "Server2", "Client3": "Server3"} // Clients and Servers mapping
var prev_neig = null; // Neighbour mapping
var next_neig = "Server2";
var own_lsp = {src: "Server1", val: {"Server2":1}}; // Based on Hoop Count
var lsps = [{S:"Server1", T:"Server2", H:1, C:0}]; // Received LSP list
